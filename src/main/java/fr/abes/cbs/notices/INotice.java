...
public interface INotice {
    ...
    void addZone(String zone, String valeur);

    void addZone(Zone zone);

    void addZoneEtatCollection(String zone, String sousZone, String valeur, char[] indicateurs) throws ExecutionControl.NotImplementedException;
