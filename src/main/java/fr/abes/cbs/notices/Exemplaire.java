...
public class Exemplaire extends Notice {
     ...
     */
    private void genererZoneA99(String lineZone, String labelZone) {
        Pattern pattern;
        Matcher matcher;
     ...
     * @param labelZone intitulé de la zone
     */
    private void genererZoneA98(String lineZone, String labelZone) {
        Pattern pattern;
        Matcher matcher;
     ...
     * @param labelZone intitulé de la zone
     */
    private void genererZoneA97(String lineZone, String labelZone) {
        Pattern pattern;
        Matcher matcher;
     ...
     */
    @Override
    public void addZoneEtatCollection(String zone, String sousZone, String valeur, char[] indicateurs) {
