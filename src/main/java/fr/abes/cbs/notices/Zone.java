...
public class Zone {
    ...
    public Zone(String label, TYPE_NOTICE typeNotice, String value) {
        this.label = label;
        this.typeNotice = typeNotice;
        this.valeur = value;
        initSpecifications();
    ...
    public Zone(String label, TYPE_NOTICE typeNotice, char[] indicateurs) {
        this.label = label;
        this.typeNotice = typeNotice;
        this.indicateurs = indicateurs;
        initSpecifications();
    ...
    public Zone(String label, TYPE_NOTICE typeNotice, char[] indicateurs, String value) {
        this.label = label;
        this.typeNotice = typeNotice;
        this.indicateurs = indicateurs;
        this.valeur = value;
    ...
    public Zone(String label, TYPE_NOTICE typeNotice) {
        this.label = label;
        this.typeNotice = typeNotice;
        initSpecifications();
    }
    ...
    private void initSpecifications() {
        ZoneSpecification zoneSpecification = ZonesSpecifications.getZoneSpecification(this.getLabel().toString(), this.typeNotice);
